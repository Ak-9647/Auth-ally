  ...
  return (
    <div className={`min-h-screen flex ${isDarkMode ? 'dark' : ''}`}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* Footer */}
        <footer className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 py-3 px-4 text-center text-sm text-gray-600 dark:text-gray-400">
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
            <div>
              © {new Date().getFullYear()} Author Ally | All Rights Reserved
            </div>
            <div className="mt-2 md:mt-0 flex items-center space-x-4">
              ...
              <a 
                href="https://github.com/Ak-9647/Auth-ally" 
                target="_blank" 
